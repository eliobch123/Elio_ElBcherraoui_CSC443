...
function connectServer($servername,$username,$password1, $password2)
{
$connection = new mysqli($servername, $username, $password1, $password2);
...
function connectDb($servername,$username,$password1, $password2, $dbname)
{
$connection = new mysqli($servername, $username, $password1, $password2, $dbname);
if ($connection->connect_error)
{
throw new Exception("Connection Error");
}
...
function addUser($connection, $tablename, $password1, $password2, $username)
{
    ...
    executeQuery($connection,"Insert into $tablename (username,password1,password2) values ('$username','$hashedPassword1','$hashedPassword2')");
    return 1;
}
